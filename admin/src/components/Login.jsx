        ...
        <form onSubmit={onSubmitHandler}>
          <div className="mb-4 min-w-72">
            ...
            <input
              ...
              value={email}
              className="w-full border border-gray-400 px-3 py-2 outline-none rounded-md"
              type="email"
          ...
          <div className="mb-4 min-w-72">
            ...
            <input
              ...
              value={password}
              className="w-full border border-gray-400 px-2 py-1 outline-none rounded-md"
              type="password"
          ...
          <button
            className="w-full bg-black text-white px-4 py-2 rounded-md mt-3"
            type="submit"
          >
            Login
          </button>
