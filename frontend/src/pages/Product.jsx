...
const Product = ()=>{
    ...
    return productData ? (
        <div className=''>
            ...
            <div className='flex flex-col sm:flex-row gap-4'>
                ...
                <div className='flex-1'>
                    ...
                    <div className='flex item-center gap-1 mt-2 p-1'>
                        ...
                        <p className='text-[12px] pl-2'>(125)</p>
                    </div>
                    ...
                    <button onClick={()=> addToCart(productData.id, size)}  className='bg-black text-white px-8 py-3 text-sm active:bg-gray-700 cursor-pointer'>ADD TO CART</button>
                    <hr className='mt-8 sm:w-3/5 h-px bg-gray-300 border-0'/>
            ...
            <div className='mt-10'>
                <div className='flex'>
                    <b className='border border-gray-300 px-5 py-3 text-sm cursor-pointer'>Discription</b>
                    <p className='border border-gray-300 px-5 py-3 text-sm cursor-pointer'>Reviews (125)</p>
                </div>
